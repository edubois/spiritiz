#ifndef _SPIRITIZ_M3U_PARSER_HPP_
#define	_SPIRITIZ_M3U_PARSER_HPP_
...
struct Grammar : qi::grammar<Iterator, std::vector<PlaylistItem>()>
{
    ...
    : Grammar::base_type(entry)
    {
        ...
        extPlaylistItem = ( lit( "#EXTINF:" ) >> int_[_a = _1] >> ',' >> as_string[ +(char_ - qi::eol) ][_b = _1] >> +qi::eol >> as_string[ +(char_ - qi::eol) ][_c = _1]  )[ _val = phx::construct<typename m3uParser::PlaylistItem>( _c, _a, _b ) ];
